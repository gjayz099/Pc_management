namespace bl.menu
{
    public class mnu
    {
        ...
        public static string Menu_P_S_S = "RMN04";
        ...
        public static string Menu_Name_P_S_S = "Products Sold Specific"; ////  Report for products sold in a specific date range
        ...
        public static List<bl.menu.mnu.Menu> mnuMenuMain = new List<bl.menu.mnu.Menu>
        {
            ...
            new bl.menu.mnu.Menu{ MenuListUI = bl.menu.mnu.Menu_Report, UI = bl.menu.mnu.Menu_P_S_S, Name = bl.menu.mnu.Menu_Name_P_S_S, Url = "/PCPMS/Report/PSS/Index"},
            /// one Menu
